export const json = {
  ...
  pages: [
          ...
          elements: [
            {
              ...
              description: 'File name to be saved in your account. This will not appear on the invoice.',
              isRequired: true,
            },
            {
              type: 'boolean',
      ...
      elements: [
        {
          ...
          description:
            'Please enter the the items included in the invoice to calculate a total.',
          elements: [
            {
              type: 'matrixdynamic',
              name: 'invoiceItems',
    ...
    },
    {
      name: 'page6',
      description:
        'Enter bank account details where invoice will be paid into:',
      elements: [
        {
          type: 'panel',
          name: 'bankDetails',
          title: 'Bank Details',
          description:
            'Please enter your account details where the invoice will be paid into.',
          elements: [
            {
              type: 'text',
              name: 'nameOnAccount',
